...
let NavBarTitleFont = UIFont.systemFont(ofSize: 18)
...
//        view.backgroundColor = PPConfig.PPColor.pageback
...
//
//    @discardableResult
//    func addNavigationBarRightItem(_ taget: Any, action: Selector, image: UIImage)  -> UIButton {
